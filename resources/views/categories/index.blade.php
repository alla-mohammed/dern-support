...
<body>
    <x-app-layout>
        <div class="py-12">
            <div class="container">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4 p-md-5">
                    ...
                    <div class="mt-5">
                        <h1 class="text-center mt-3 h1 mb-4">Categories Data</h1>
                        <div class="text-center mt-2 mb-4">
                            <a href="/add-catgory" class="btn btn-dark btn-block">Add Category</a>
                        </div>
                            ...
                            <table class="table text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success mb-1 mb-md-0" href="/form-update/{{ $catgory->id }}">Update</a>
                                            <a class="btn btn-primary mb-1 mb-md-0" href="/show/{{ $catgory->id }}">Show</a>
                                            <form action="/form-delete/{{ $catgory->id }}" method="post" class="d-inline">
                                                @csrf
